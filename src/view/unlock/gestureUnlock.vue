<template>
  <div class='gestureUnlock'>
    <canvas id="gestureUnlock" ref="canvas" class="panel"/>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted() {
      let vue = this;
      vue.canvas = this.$refs.canvas;
      vue.ctx = this.canvas.getContext('2d');

      vue.canvas.width = vue.style.width * vue.devicePixelRatio;
      vue.canvas.height = vue.style.height * vue.devicePixelRatio;
